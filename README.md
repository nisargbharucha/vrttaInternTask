...
Vrtta/
├── .env                # Stores environment variables (SECRET_KEY, PORT, etc.)
...
└── app/                # Main Flask application package
    ...
    ├── models/         # (Empty for now - database models)
    ├── services/       # (Empty for now - business logic)
    └── routers/        # API route blueprints
        ├── __init__.py # Makes 'routers' a package
        └── routes.py   # Defines main application routes
